  ...
  return (
    <div>
      <Head>
        ...
        {/* Link preview */}
        <meta property="og:title" content="Character Detector" />
        <meta
          ...
          <div className="mx-auto max-w-3xl space-y-5 pt-3">
            ...
            <div className="shadow-sm rounded p-2 min-h-[50px] w-full bg-white grid gap-[2px] grid-cols-[repeat(auto\-fill,2.5rem)]">
              {valueBlocks.map(({ char, block }, index) => {
                ...
                return (
                  <div
                    className="rounded w-10 h-10 flex items-center justify-center border-[1px] text-white cursor-pointer select-none font-mono"
                    style={{
